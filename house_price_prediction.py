...
def preprocess_data(dataset):
    ...
    features = input("Enter feature column names separated by commas without quotes: ").split(",")
    if not features:
...
# Load the dataset
file_path = r'https://drive.google.com/uc?export=download&id=1obUDn4ijFfEwZ708zDbNL4JzizquGGjP'  # Replace with actual file path
